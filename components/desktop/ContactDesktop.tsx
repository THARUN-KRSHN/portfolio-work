...
const socials = [
    { label: 'Instagram', href: 'https://instagram.com/', note: 'Behind the scenes and daily life.' },
    { label: 'LinkedIn', href: 'https://linkedin.com/', note: 'Professional enquiries welcome.' },
    { label: 'Agency', href: '#', note: 'Direct booking through representation.' },
]

export default function ContactDesktop() {
    return (
        <section id="contact" className="bg-bg-primary border-t border-border">
            ...
            <div className="max-w-2xl mx-auto px-8 py-20">
                <p className="font-ui text-sm text-text-muted mb-12 leading-relaxed">
                    For bookings, collaborations, and press enquiries — fill out the form below
            ...
            <div className="px-24 py-16 border-t border-border">
              ...
              <span className="font-ui text-sm text-text-muted">{note}</span>
              <span className="text-text-muted group-hover:text-accent-red transition-colors">↗</span>
            </a>
          ))}
            </div>
        </div>
